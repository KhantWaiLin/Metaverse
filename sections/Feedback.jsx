...
const Feedback = () => (
  <section className={`${styles.paddings} relative z-10`}>
    <motion.div
      ...
      className={`${styles.innerWidth} flex mx-auto flex-col lg:flex-row gap-6`}
    >
      <motion.div
      ...
      >
        ...
        <div>
          <h4 className='font-bold sm:text-[32px] text-[26px] sm:leadig-[40px] leading-[36px] text-white'>
            Samantha
          </h4>
      ...
      <motion.div
        className='flex relative flex-1 items-center justify-center'>
        <img
          src='/planet-09.png'
          alt='planet-09'
